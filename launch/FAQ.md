...
Yes. An ambient track plays when allowed by your browser. It respects reduced-motion and visibility settings where possible.
...
On launch day via the website and official X. The site contract section will update automatically when `NEXT_PUBLIC_CONTRACT` is set.

### Are tokenomics finalized?
...
**No.** Eligible participants **may become eligible** for a future allocation. Manual review applies. No guaranteed amount.

### Do you use Galxe, Zealy, or QuestN?

**No.** Verification is manual. No third-party quest platforms in the current plan.

### Is wallet connect live?

**Not yet.** It is a future Deer Trail milestone.

### When will full claim rules be published?

Before token launch. The site currently states: *Full claim rules will be announced before launch.*
