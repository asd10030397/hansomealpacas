...
**Contract status:** Not deployed. No token has been minted as part of this planning phase.

When the token exists, contract details will be published on the website and official X. Until then, treat any unofficial contract address as invalid.
...
## 5. Tokenomics (high level)

Detailed allocation is **placeholder** until finalized. See [TOKENOMICS.md](./TOKENOMICS.md).

No fixed percentages are binding in this whitepaper. Liquidity, treasury, community, and team buckets remain TBD. The project does not promise a specific APY, burn schedule, or buyback program.

---

## 6. Vision

**Short term:** Live website, active X, deer culture spreading through shares and memes, token launch when ready.
...
- Not a registered security offering
- Not a commitment to CEX listing, staking rewards, or governance tokens

See [DO_NOTS.md](./DO_NOTS.md) for the full list of intentional non-promises.
