...
| Logo 512×512 | https://kairu.lol/logo/logo-512.png |
| Logo 256×256 | https://kairu.lol/logo/logo-256.png |
...
| Logo | `https://kairu.lol/logo/logo-512.png` (paste in logo field / upload) |
...
2. If missing or no logo: contact DeBank via https://debank.com/about (official listing) or Rabby support with:
   ...
   - Logo URL: `https://kairu.lol/logo/logo-512.png`
   - Website: `https://kairu.lol`
...
| -------- | ---- | ---- | ------ |
| Trust Wallet / GitHub assets PR | `logo.png` | **256×256** | PNG, square |
| Uniswap token list `logoURI` | `logo-512.png` | **512×512** | PNG (also valid for lists) |
| Wallets / high-DPI | `logo-512.png` | 512×512 | PNG |
| SVG (optional) | `logo.svg` / `coin.svg` | scalable | SVG |
...
Outputs: `public/logo/logo-256.png`, `public/logo/logo-512.png`.
