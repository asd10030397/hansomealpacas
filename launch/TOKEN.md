...
| Mint authority | TBD |
| Freeze authority | TBD |
| Deploy date | TBD |

When deployed, add to Vercel:
...
The site contract section, copy button, and action links activate automatically when `NEXT_PUBLIC_CONTRACT` is set.
