...
| Token | Hex | Usage |
|---|---|---|
| Background | `#090909` | Primary page background |
...
- **Headlines:** Anton, uppercase, generous tracking
- **Body:** Noto Sans TC (Traditional Chinese), system sans fallback
- **Monospace:** System mono for trail checkmarks and contract addresses
