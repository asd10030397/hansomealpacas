...
export type GameMessages = {
  ...
  result: {
    ...
    yourNftsTitle: string;
    yourNftsHint: string;
    otherParticipantsTitle: string;
    otherParticipantsHint: string;
    yourNftBadge: string;
    ownerLabel: string;
    statusLabel: string;
    rewardLabel: string;
    ...
    revealQueueEyebrowGasless: string;
    ...
    missedRevealBodyGasless: string;
  };
  docs: {
    heading: string;
    blurb: string;
    dailyLoopTitle: string;
    dailyLoopSteps: [string, string, string] | [string, string, string, string];
    poolsTitle: string;
    poolAlpaca: string;
