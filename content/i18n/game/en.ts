...
export const gameEn: GameMessages = {
  ...
  launch: {
    ...
    cycleSteps: [
      ["CHOOSE", "You must Commit — pick location"],
      ["REVEAL", "You must Reveal; check results next day"],
      ["RESULT", "Battle & settle"],
      ["CLAIM", "Rewards to NFT"],
    ],
    cycleNote:
      "You must Commit and Reveal each day → settle → Claim. Rewards book to the NFT.",
  ...
  mint: {
    ...
    opensSoon: "Mint opens soon",
    notOnWhitelist: "Not on whitelist",
    opensIn: "Opens in",
    opensAt: (when) => `Whitelist opens ${when}`,
    soldOut: "Sold out.",
  ...
  explore: {
    ...
    flowSteps: [
      ["SELECT NFT", "Pick which NFT to deploy; repeat for others"],
      ["COMMIT HERE", "You must Commit — tap a location"],
      ["REVEAL", "You must Reveal; check results next day"],
      ["BATTLE RESULT", "Settles after Reveal"],
  ...
  forum: {
    heading: "FORUM",
    blurb:
      "Tactics discussion for Genesis NFT holders. Post and reply as one of your owned NFTs.",
    gateNote:
      "Connect a wallet, own at least one Genesis NFT, and sign a short message to post.",
    featureName: "Forum",
    boardName: "Tactics",
    boards: {
      tactics: "Tactics",
    ...
    bugReportNotice:
      "Found a bug or something broken? Post in Bugs & Issues to notify the team.",
    boardSwitcherAria: "Forum boards",
    bugsBodyPlaceholder: "Describe the bug or issue — steps to reproduce help…",
    composerTitle: "New post",
    threadsTitle: "Threads",
    repliesTitle: "Comments",
    commentsTitle: "Comments",
    bodyLabel: "Body",
    bodyPlaceholder: "Share tactics, questions, or observations…",
    replyLabel: "Comment",
    commentLabel: "Comment",
    replyPlaceholder: "Write your comment…",
    commentPlaceholder: "Write your comment…",
    commentComposerTitle: "Leave a comment",
    postAsHint: "Choose which Genesis NFT you are posting as.",
    selectNftHint: "Select an NFT above to continue.",
    signHint: "You will sign a wallet message — no gas fee.",
    likeSignHint: "Sign a wallet message to like — no gas fee.",
    signing: "Signing…",
    createThread: "CREATE THREAD",
    postReply: "POST COMMENT",
    postComment: "POST COMMENT",
    like: "Like",
    unlike: "Unlike",
    likeCountLabel: (count) => (count === 1 ? "1 like" : `${count} likes`),
    noNftBody: "You need at least one Genesis NFT in this wallet to post.",
    emptyThreads: "No threads yet. Start the first discussion.",
    emptyReplies: "No comments yet.",
    emptyComments: "No comments yet.",
    loadError: "Could not load forum data.",
    notFound: "Thread not found.",
    backToBoard: "Back to forum",
    metaLine: (when, commentCount, likeCount) =>
      `${when} · ${commentCount} ${commentCount === 1 ? "comment" : "comments"} · ${likeCount} ${likeCount === 1 ? "like" : "likes"}`,
    delete: "Delete",
    deleting: "Deleting…",
    deleteSignHint: "Sign a wallet message to delete — no gas fee.",
    deleteThreadConfirm: "Delete this thread? This cannot be undone.",
    deleteReplyConfirm: "Delete this comment? This cannot be undone.",
  },
  commit: {
  ...
  docs: {
    ...
    dailyLoopSteps: [
      "CHOOSE LOCATION — you must Commit where your NFT goes",
      "REVEAL — you must Reveal on-chain; check results next day",
