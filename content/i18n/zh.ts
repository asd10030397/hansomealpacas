...
export const zh: Messages = {
  ...
  swap: {
    ...
    watchAssetSuccess: "已加入 UGLY — 請在 MetaMask 確認 Logo 顯示。",
    watchAssetFailed: "無法加入 UGLY 至錢包。",
    watchAssetRejected: "您已取消加入 UGLY。",
  ...
  market: {
    eyebrow: "MARKET",
    title: "MARKET STATS",
    subtitle: "GeckoTerminal 即時 UGLY/ETH 池數據（Robinhood Chain Uniswap v4）。",
    loading: "Loading",
