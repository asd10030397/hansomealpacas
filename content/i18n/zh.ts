  ...
  litepaper: {
    ...
    nav: {
      ...
      sections: {
        ...
        roadmap: "路線圖",
        community: "社群",
        "sustainable-ecosystem": "建立可持續發展的生態系",
    ...
    downloadPdf: "下載白皮書 PDF",
    downloadEconomicModelPdf: "經濟模型 PDF",
    documentsLibrary: {
      heading: "文件下載（DOC）",
      blurb:
        "本站 /docs 提供的正式下載檔。分享建議用 PDF；在編輯器閱讀可用 Markdown。",
      litepaperEn: "白皮書（英文 PDF）",
      litepaperZh: "白皮書（中文 PDF）",
      economicPdfEn: "GameFi 經濟模型（英文 PDF）",
      economicPdfZh: "GameFi 經濟模型（中文 PDF）",
      economicMdEn: "GameFi 經濟模型（英文 Markdown）",
      economicMdZh: "GameFi 經濟模型（中文 Markdown）",
      openInBrowser: "開啟",
    },
    hero: {
      eyebrow: "白皮書",
    ...
    philosophy: {
      ...
      pillars: [
        ...
        {
          title: "透明公開",
          body: "這個專案涉及的四個錢包——部署錢包、流動性錢包、金庫與創辦人錢包——全部公開，任何時候都能在鏈上查證。詳見下方「金庫政策」章節，以及即時更新的 /transparency 頁面，查看目前地址與餘額。官方錢包、金庫動向、流動性資訊等透明度相關資料都會放在那個頁面上，並盡可能以鏈上資訊即時更新。金庫執行的每一項流動性操作——包括「流動性政策」章節中提到的 2026 年 7 月流動性優化——都是透過任何人都能查證的公開交易完成的，而原始的鎖倉部位在整個過程中完全沒有被動過。這些決策追求的都是長期的可持續發展，而不是短期的熱度。",
        },
        {
          title: "長期思維",
    ...
    gameplayOverview: {
      heading: "遊戲簡介",
      opening: "HANSOME: Alpacas vs Cougars 不只是一個 NFT 收藏系列。",
      paragraphs: [
        "每一隻 Genesis NFT 都是鏈上生存遊戲中的可遊玩角色，玩家將在遊戲中競爭、生存並獲得獎勵。",
        "玩家可以成為：",
      ],
      roles: [
        "🦙 羊駝——躲避狩獵、努力生存並撐到最後。",
      ...
      closing: [
        "提交行動 → 揭露行動 → 結算 → 領取獎勵",
        "不同的 NFT 特性與能力將影響遊戲體驗與策略選擇。",
        "本白皮書僅提供遊戲生態的簡單介紹。",
        "若想了解完整玩法、NFT 能力、地點、獎勵池、結算規則與領獎方式，請前往 Game 頁面。",
      ],
      imageAlt: "像素藝術：美洲獅與叼著草的羊駝在山間草地對峙",
    ...
    liquidity: {
      ...
      longTermStrategy: {
        heading: "長期 LP 策略",
        body: "目前的做法偏好維持少數幾個容易理解的部位，而不是不斷微調。我們期望的長期結構是「杠鈴型」：一個靠近目前價格、資金效率較高的窄區間部位，再加上至少一個更寬或全區間的部位作為常態後備，確保單一一筆大額交易永遠無法把某個方向的可交易流動性完全耗盡。截至 2026 年 7 月，這個杠鈴結構已經正式上線——詳見下方「流動性優化」。",
      },
      lpFees: {
        heading: "LP 手續費",
      ...
      liquidityOptimization: {
        heading: "流動性優化（2026 年 7 月）",
        body: "2026 年 7 月，金庫在官方 Uniswap v4 資金池上完成了一次流動性優化。原始鎖倉 365 天的部位（#47299，詳見上方「上鏈驗證」）完全沒有被動過，鎖倉狀態沒有被解除或更改。在它之外，金庫另外新增了兩個由金庫持有的流動性部位：一個窄區間部位，用來降低目前價格附近的交易滑價；以及一個寬區間部位，作為額外的下跌保護。加總起來，這讓官方流動性背後的資金規模，比原本只有單一鎖倉部位時明顯提高。這一切資金都來自公開揭露的金庫流動性管理，每一步都可以在鏈上公開查證。",
      },
      improvedTradingExperience: {
        heading: "交易體驗改善",
        body: "在上述優化之後，官方資金池在一般交易規模下的滑價已經明顯降低。中大額交易現在的執行效率更高，價格衝擊比之前更小。目前價格兩側的市場深度都變得更好，第一次買進的新持有人，體驗也比之前明顯順暢許多。",
      },
      multiplePositions: {
        heading: "多個 LP 部位",
        body: "單一集中流動性部位在每個方向上都有明確的容量上限。同時運作多個部位——分布在不同價格區間、甚至來自不同資金來源——是有經驗的集中流動性操作者，避免單一部位變成單點故障的標準做法。如上方「流動性優化」所述，這個做法目前已經在 HANSOME 上實作完成：原始鎖倉部位現在與另外兩個金庫持有的新部位一起運作。",
      },
      noReactiveChasing: {
      ...
      phases: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "由金庫主導，完成官方 Uniswap v4 資金池的流動性優化，在原始鎖倉部位之外新增兩個金庫持有的流動性部位（詳見「流動性政策」）",
              done: true,
            },
            { label: "改善 Robinhood Chain 上的交換基礎設施與 Gas 費用處理，提升交易可靠性", done: true },
            { label: "建立內部工具，協助金庫進行流動性管理", done: true },
            { label: "持續針對網站與整體交易體驗進行漸進式改善", done: false },
    ...
    community: {
      ...
      paragraphs: [
        ...
        "這已經不只是一個希望了。我們已經有一個真正在運作的 Telegram 社群，靠自然成長慢慢變大，而不是靠付費推廣衝出來的。我們會定期舉辦迷因比賽、抽獎、AMA 問答與社群活動，給真正願意參與的人，也開始與 KOL 合作、推動更廣泛的行銷活動，把值得留下來的人帶進來。社群的參與度，正逐漸成為這個專案最重要的優先事項之一，和金庫、流動性的自律並列。",
      ],
    },
    sustainableEcosystem: {
      heading: "建立可持續發展的生態系",
      paragraphs: [
        "建立一個可持續發展的生態系，是我們的長期願景。",
        "我們的目標不只是推出一個 NFT 系列。",
        "HANSOME: Alpacas vs Cougars NFT Mint 所產生的收入，將重新投入 HANSOME 生態系，用於：",
      ],
      investments: [
        "🎮 遊戲開發",
        "📢 社群活動與獎勵",
      ...
      closing: [
        "隨著生態系持續成長，我們希望為 NFT 持有者與整個 HANSOME 社群創造更多價值。",
        "更強大的生態系會吸引更多玩家。",
        "更多玩家會形成更健康的社群。",
        "更健康的社群會支持未來的持續開發。",
        "這就是我們正在建立的成長飛輪。",
    ...
    changelog: {
      ...
      entries: [
        ...
        },
        {
          ...
          date: "2026 年 7 月",
          changes: [
            "新增「遊戲簡介」章節，附上羊駝對美洲獅插圖，並提供前往 Game 頁面的 CTA。",
            "新增「建立可持續發展的生態系」章節，說明 Mint 收入再投入與生態成長飛輪。",
          ],
        },
        {
          version: "v1.5",
          ...
          date: "2026 年 7 月",
          changes: [
            "由金庫主導，完成官方 Uniswap v4 資金池的流動性優化：新增兩個金庫持有的部位——一個窄區間部位用於降低交易滑價，一個寬區間部位提供額外的下跌保護——同時原始鎖倉 365 天的部位（#47299）完全維持不變。",
            "更新「流動性政策」章節，反映原本規劃中的杠鈴型流動性策略現已正式上線，橫跨三個金庫相關的部位。",
            "新增交易體驗改善的說明：交易滑價降低、中大額交易執行效率提升、市場深度改善。",
            "新增近期基礎設施改善的說明：交換基礎設施、Robinhood Chain 上的 Gas 費用處理、交易可靠性，以及內部流動性管理工具。",
            "擴充「社群」章節，加入 AMA 問答、KOL 合作與持續進行的行銷活動，與現有的迷因比賽、抽獎、社群活動並列。",
            "擴充「核心理念」中的「透明公開」項目，明確說明所有流動性操作都在鏈上進行且可公開查證，專案優先追求長期可持續發展，而不是短期熱度。",
          ],
        },
        {
          version: "v1.4",
