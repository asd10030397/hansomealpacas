  ...
  litepaper: {
    ...
    liquidity: {
      ...
      liquidityOptimization: {
        ...
        body: "2026 年 7 月，金庫在官方 Uniswap v4 資金池上完成了一次流動性優化。原始鎖倉 365 天的部位（#47299，詳見上方「上鏈驗證」）完全沒有被動過，鎖倉狀態沒有被解除或更改。在它之外，金庫另外新增了兩個由金庫持有的流動性部位：一個窄區間部位，用來降低目前價格附近的交易滑價；以及一個寬區間部位，作為額外的下跌保護。加總起來，目前所有部位的官方流動性已超過 10,000 美元。這一切資金都來自公開揭露的金庫流動性管理，每一步都可以在鏈上公開查證。",
      },
      ...
      entries: [
        {
          ...
          changes: [
            ...
            "更新「流動性政策」章節，反映原本規劃中的杠鈴型流動性策略現已正式上線，所有部位加總的官方流動性已超過 10,000 美元。",
