...
export default function ExplorePage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-3 py-6">
      ...
      <h1 className="pixel-title text-lg text-[#f0c44a]">EXPLORE</h1>
      <p className="mt-2 text-sm text-[var(--hg-muted)]">
        Choose a destination for today&apos;s commit. Location names are placeholders until
        world design is approved. Weights follow GDS: 1 / 2 / 3 / 5 / 8.
      </p>
