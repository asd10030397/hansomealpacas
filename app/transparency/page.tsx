  ...
  return (
    <main id="main-content" className="relative min-h-screen overflow-hidden px-6 pb-20 pt-16">
      ...
      <section className="relative z-10 mx-auto flex w-full max-w-4xl flex-col py-12 text-center">
        ...
        <section aria-labelledby="notice-title" className="gold-border mt-12 w-full rounded-2xl bg-white/[0.02] p-6 text-left sm:p-8">
          <h2
            id="notice-title"
          ...
          <div className="mt-4 space-y-3 text-sm leading-relaxed text-muted sm:text-base">
            ...
            <p>UGLY is committed to transparent on-chain operations.</p>
          </div>
        </section>
      </section>
    </main>
