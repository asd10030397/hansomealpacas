// Combine every glasses review image into ONE tall PNG for a single-file visual review.
import sharp from "sharp";
import fs from "node:fs";
import path from "node:path";

const PREV = "public/pixel/traits/glasses/previews";
const order = [
  "_ALL-GLASSES.png",
  "_COMPARISON-puff.png",
  "round-glasses__contact.png",
  "reading-glasses__contact.png",
  "sunglasses__contact.png",
  "heart-glasses__contact.png",
  "farm-goggles__contact.png",
];
