// Combine every ear-accessory review image into ONE tall PNG for a single-file visual review.
import sharp from "sharp";
import fs from "node:fs";
import path from "node:path";

const PREV = "public/pixel/traits/ears/previews";
const order = [
  "_EAR-ANCHORS.png",
  "_ALL-EARS.png",
  "_COMPARISON-puff.png",
  "small-flower__contact.png",
  "leaf-clip__contact.png",
  "tiny-bell__contact.png",
  "feather__contact.png",
  "golden-ear-tag__contact.png",
];
