// Combine every necklace review image into ONE tall PNG for a single-file visual review.
import sharp from "sharp";
import fs from "node:fs";
import path from "node:path";

const PREV = "public/pixel/traits/necklaces/previews";
const order = [
  "_ALL-NECKLACES.png",
  "_COMPARISON-puff.png",
  "hansome-pendant__contact.png",
  "bell-collar__contact.png",
  "clover-pendant__contact.png",
  "wooden-beads__contact.png",
  "berry-string__contact.png",
];
...
for (const t of tiles) {
  comps.push({ input: t.buf, left: Math.round((SW - t.w) / 2), top: y });
  y += t.h + GAP;
}
